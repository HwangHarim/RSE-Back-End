...
//    @PatchMapping(value = "/{board_id}comment/{id}")
...
//    public ResponseEntity<ResponseDto> deleteComment(@PathVariable("boardid") Long boardId, @PathVariable("commentId") Long commentId) {
